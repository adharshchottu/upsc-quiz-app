...
import { Box, Button, ButtonGroup, Card, CardBody, CardFooter, CardHeader, Center, Divider, Heading, Radio, RadioGroup, Stack, StackDivider, Text } from "@chakra-ui/react";
import articlesDataSet from "../data/articles";
import articlesHighlightDataSet from "../data/articlesHighlight";
import { DataSet } from "../data/dataset";

type handleChangeType = (event: React.ChangeEvent<HTMLInputElement>) => void;
type HandleOptionChange = (option: string) => void;

const articlesDataGenerator = () => {
...
const Articles: React.FC = () => {
    ...
    const [quizData, setQuizData] = useState(articlesDataGenerator());
    ...
    const nextQuestion = () => {
        ...
        setQuizData(articlesDataGenerator());
